...
export const Route = createFileRoute('/solutions/consulting-coaching')({
  component: ConsultingCoachingPage,
  head: () =>
    generateMetaTags({
      title: 'Consulting & Coaching SEO | Build Your Authority',
      description:
      ...
      url: 'https://onepercentseo.com/solutions/consulting-coaching',
    }),
});

function ConsultingCoachingPage() {
  const solution = getSolutionBySlug('consulting-coaching');
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center">
            <h2 className="font-bold text-4xl tracking-tight lg:text-6xl">
              Challenges Facing Consultants & Coaches
            </h2>
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground leading-relaxed tracking-wide">
              Consultants and coaches face unique personal branding challenges.
      ...
      <section className="px-6 py-20 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground leading-relaxed tracking-wide">
              A systematic process designed specifically for consultants and
              coaches to build authority and attract clients.
            </p>
          </div>
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      <section className="px-6 py-20 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground leading-relaxed tracking-wide">
              Comprehensive SEO and GEO solutions tailored for consultants,
      ...
      <section className="px-6 py-20 lg:py-32">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground leading-relaxed tracking-wide">
            Let's establish your thought leadership and attract high-value
            clients with proven SEO and GEO strategies.
          </p>
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button
              asChild
