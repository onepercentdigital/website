...
export const Route = createFileRoute('/solutions/real-estate')({
  ...
  head: () =>
    generateMetaTags({
      ...
      description:
        'Drive qualified leads for real estate agents, brokerages, developers, and luxury home builders. Own property searches in your market with SEO, GEO, and PPL.',
...
function RealEstatePage() {
  ...
  const iconMap: Record<string, typeof Building06Icon> = {
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground leading-relaxed tracking-wide">
              Real estate agents and brokerages face intense competition. Here's
      ...
      <section className="px-6 py-20 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground leading-relaxed tracking-wide">
              A systematic process designed specifically for real estate
              professionals to generate qualified buyer and seller leads.
            </p>
          </div>
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      <section className="px-6 py-20 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground leading-relaxed tracking-wide">
              Comprehensive SEO, GEO, and PPL solutions tailored for real estate
      ...
      <section className="px-6 py-20 lg:py-32">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground leading-relaxed tracking-wide">
            ...
            GEO, and PPL strategies built for real estate professionals.
          </p>
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button render={<Link to="/apply" />} size="lg">
              Apply To Work With Us
